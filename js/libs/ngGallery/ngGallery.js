(function () {
    ...
    function ngGallery($document, $timeout, $q, $templateCache) {
        ...
        $templateCache.put(template_url,
            ...
            '<a href="{{getImageDownloadSrc()}}" target="_blank" ng-show="showImageDownloadButton()" class="download-image"><i class="glyphicon glyphicon-floppy-disk"></i></a>' +
            '  <a class="close-popup" ng-click="closeGallery()"><i class="glyphicon glyphicon-remove"></i></a>' +
            '  <a class="nav-left" ng-click="prevImage()"><i class="glyphicon glyphicon-chevron-left"></i></a>' +
            '  <img ondragstart="return false;" draggable="false" ng-src="{{ img }}" ng-click="nextImage()" ng-show="!loading" class="effect" />' +
            '  <a class="nav-right" ng-click="nextImage()"><i class="glyphicon glyphicon-chevron-right"></i></a>' +
